        ...
        <div class="card" style="width: 21rem;">
            ...
            <div class="card-footer">
                <div class="d-flex w-100 justify-content-between align-items-end">
                     <a href="{{route('reception.subscribers',$plan->id)}}" class="btn btn-success">subscribers({{count($plan->subscribers)}})</a>
                     <a href="{{route('plan.form',$plan->id)}}" class="btn btn-primary justify-self-end">register</a>
