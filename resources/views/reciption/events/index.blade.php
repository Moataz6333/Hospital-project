            ...
            <div class="card" style="width: 21rem;">
                ...
                <div class="card-footer">
                    <div class="d-flex w-100 justify-content-between align-items-end">
                        <a href="" class="btn btn-success">subscribers({{count($event->followers)}})</a>
                        <a href="{{route('reception.event.show',$event->id)}}" class="btn btn-primary justify-self-end">register</a>
                    </div>
                </div>
            </div>
        @endforeach
