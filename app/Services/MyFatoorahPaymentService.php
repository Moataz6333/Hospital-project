...
class MyFatoorahPaymentService
{
    ...
    private function getPayLoadData()
    {
        ...
        return [
            'CustomerName'       => $this->appointment->patien->name,
            'InvoiceValue'       => (double) $this->appointment->doctor->price,
            'DisplayCurrencyIso' => config('app.currency'),
            'CustomerEmail'      => 'test@test.com',
            'CallBackUrl'        => $callbackURL,
            'ErrorUrl'           => $callbackURL,
            'MobileCountryCode'  => '+20',
            'CustomerMobile'     => $this->appointment->patien->phone,
            'Language'           => 'en',
            'CustomerReference'  => $this->appointment->patien->id,
    ...
    public function checkout()
    {
        try {
            //You can get the data using the order object in your system
            // $orderId = $this->appointment->id;
            $order   = $this->getTestOrderData();
            // $order =null;

            //You can replace this variable with customer Id in your system
            $customerId = $this->appointment->patien->id;
    ...
    {
        return [
            'total'    =>(double) $this->appointment->doctor->price,
